...
- **It says nothing about the last component.** Whether an operation acts on a link or on
  ...
  inside (S15). Only opening something that already exists follows a final link. Those
